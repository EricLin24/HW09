from HW10_ZiangLin import Repository, InsInf, StuInf
import unittest
...
class HW10Test(unittest.TestCase):
    ...
    def test_get_stu(self):
        ...
        cwid, name, major, courses, rre, rel = stu.cwid, stu.name, stu.major, stu.courses, stu.req_c(), stu.ele_c()
        ...
        self.assertEqual(rre,['SSW 540', 'SSW 555'])
